      ...
      <div class="widget-box transparent">
         <div class="widget-header widget-header-large">
            ...
            <div class="widget-toolbar hidden-480">
               <a href="{{route('order.export', ['id' => $order->Id, 'type' => 'sel'])}}">
...
{{--                           <li><i class="ace-icon fa fa-caret-right blue"></i>Tổng phụ:<b>{{ number_format($order->OrderTotalDiscount) }}</b></li>--}}
                            <li><i class="ace-icon fa fa-caret-right blue"></i>Giảm giá:<b>{{ floatval($order->f_Discount) }}</b></li>
                     ...
                     <table id="simple-table" class="table table-bordered table-hover table-responsive">
                        ...
                        @forelse($order->OrderDetail as $key=> $d_order)
                           <tr>
                              ...
                              <td class="center">{{$d_order->m_Discount}}</td>
