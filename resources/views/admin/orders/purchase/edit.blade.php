                ...
                <table class="table table-bordered" id="products_table">
                    ...
                    @foreach($order->OrderDetail as $k => $ord)
                        <tr class="{{$ord->Id}}">
                            ...
                            <td>{{$ord->Unit}}</td>
                            <td class="qty">
                                <input type="number" name="quantities[]" class="form-control qty" value="{{$ord->Qty}}" min="0"/>
                            </td>
                            ...
                            <td class=""><textarea type="text" name="description[]" value="{{$ord->Description}}" class=""></textarea></td>
