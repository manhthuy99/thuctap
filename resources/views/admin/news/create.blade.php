                            ...
                            <div class="form-group col-md-12 col-lg-12 col-xs-12">
                                ...
                                <div class="clearfix">
                                    ...
                                    <textarea id="shortContent" rows="6" class="form-control"
                                        name="shortContent">{{ old('shortContent') }}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 form-group col-md-12 col-lg-12">
                                ...
                                <div class="clearfix">
                                    <textarea id="fullContent" rows="6" class="form-control"
                                        name="fullContent">{{ old('fullContent') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-lg-4 col-xs-4">
                            <div class="form-group col-xs-12 col-md-12 col-lg-12">
                                ...
                                <div class="clearfix">
                                    ...
                                    <img id="showImg" src="" alt="Hình Ảnh" width="100%">
                            ...
                            <div class="form-group col-xs-12 col-md-12 col-lg-12">
                                ...
                                <div class="clearfix">
                                    <input type="checkbox" name="is_hot" id="is_hot">Tin mới
                                   
                                    <input type="checkbox" name="is_feature" id="is_feature">Tin nổi bật

                                    <input type="checkbox" name="is_home" id="is_home">Tin trang chủ
                                </div>
